    ...
    return (
        ...
        >
            ...
            <text
                ...
                strokeWidth="0.5"
                className="font-[helvetica] font-bold stroke-gray-500/60 dark:stroke-neutral-800 fill-transparent text-7xl  "
            ...
            <motion.text
                ...
                dominantBaseline="middle"
                strokeWidth="0.5"
                className="font-[helvetica] font-bold fill-transparent text-7xl   stroke-gray-500/60 dark:stroke-neutral-800"
